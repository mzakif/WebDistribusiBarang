...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Stok Kirim Produk</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-bordered" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php
                                        if (is_array($stokUp)) {
                                            foreach ($stokUp as $row) {
                                                if ($row['status'] == '1') { ?>
                                                    <tr>
                                                        <td><?= $row['iddistribusi']; ?></td>
                                                        <td><?= $row['idstokkirim']; ?></td>
                                                        <td><?= $row['idproduk']; ?></td>
                                                        <td><?= $row['nama']; ?></td>
                                                        <td><?= $row['stokdkirim']; ?></td>
                                                        <td><?= $row['stock']; ?></td>
                                                        <td>
                                                            <a href="#" role="button" data-toggle="modal" data-target="#modal_update_status" data-id="<?= $row['idproduk']; ?>" data-nama="<?= $row['idproduk']; ?>">Update</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                            }
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">Data Stok Kirim Bahan Baku</h6>
                        </div>
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="dataTable" class="table table-bordered" width="100%" cellspacing="0">
                                            ...
                                            foreach ($stokUp2 as $row) {
                                                if ($row['status'] == '1') { ?>
                                                    <tr>
                                                        ...
                                                        <td><?= $row['qty']; ?></td>
                                                        <td>
                                                            <a href="#" role="button" data-toggle="modal" data-target="#modal_update_status2" data-id="<?= $row['idbahanbaku']; ?>" data-nama="<?= $row['idbahanbaku']; ?>">Update</a>
                                                        </td>
                                                    </tr>
                                                <?php
                                            }
                ...
                <div class="card shadow mb-4">
                    <div class="card-header py-3">
                        <h6 class="m-0 font-weight-bold text-primary">Keterangan : Data Dengan Status 0 tidak dapat di update</h6>
                    </div>
                </div>
                <!-- /.container-fluid -->
            </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-inline" id="form_update_status" method="POST">
                        <label class="mr-sm-2">stock: </label>
                        <input type="text" class="form-control mb-2 mr-sm-2 mb-sm-0" name="stock" id="stock" placeholder="Masukan Nilai StockDiKirim" required>
                    </form>
                </div>
                <div class="modal-footer">
    ...
    <!-- modal bahanbaku -->
    <div class="modal fade" id="modal_update_status2">
        <div class="modal-dialog modal-md">
            <!-- Modal content -->
            <div class="modal-content">
                <div class="modal-header">
                ...
                <div class="modal-body">
                    <form class="form-inline" id="form_update_status2" method="POST">
                        <label class="mr-sm-2">stock: </label>
                        <input type="text" class="form-control mb-2 mr-sm-2 mb-sm-0" name="qty" id="qty" placeholder="Masukan Nilai StockDiKirim" required>
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-sm btn-primary" data-dismiss="modal">Tidak</button>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#modal_update_status').on('show.bs.modal', function(e) {
                ...
                form.attr('action', "<?= base_url('karyawan/update_produk/') ?>" + id);
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $('#modal_update_status2').on('show.bs.modal', function(e) {
                var btn = $(e.relatedTarget);
                var id = btn.data('id');
                var nama = btn.data('nama');
                var modal = $(this);
                var form = modal.find('#form_update_status2');
                form.attr('action', "<?= base_url('karyawan/update_bahanbaku/') ?>" + id);
                modal.find('.modal-title span.detail').text(`${id}-${nama}`);
                modal.find('.modal-action').on('click', function() {
                    form.submit();
                });
