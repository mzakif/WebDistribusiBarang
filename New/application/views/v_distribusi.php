                                ...
                                <tbody>
                                    ...
                                    if (is_array($barang)) {
                                        foreach ($barang as $row) { ?>
                                            <tr>
                                                <form method="post" action="<?php echo base_url(); ?>manager/tambah" method="post" accept-charset="utf-8">
                                                    ...
                                                    <td><button type="submit" class="btn btn-sm btn-success"><i class="fas fa-shopping-cart"></i> Ambil </button></td>
                                                </form>
                                            </tr>
                                        <?php
                                    }
